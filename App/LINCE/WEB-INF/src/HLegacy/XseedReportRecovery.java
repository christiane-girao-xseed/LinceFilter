...
public class XseedReportRecovery implements Serializable
{ 
	...
	public transient ResultSet XSEED_SQL=null;
	public transient Statement XSEED_CMD=null;
	...
	public transient BufferedReader  acceptFile;  


	public XseedGLBRecovery GLB = new XseedGLBRecovery(); 
...
//	ShowErrorMsg
	...
	public void updateRecoveryErrorStatus()
	throws Exception
	{   
	}
	 
	public void postErrorActions()
	throws Exception
	{   
	}
...
//	AuditERR
	...
	throws Exception
	{
		...
		{	
			...
			audit.println("EOP:" + format(dateToday, "yyyy/MM/dd HH:mm:ss") + " Rep: "+ GLB.REPNAME + " Msg: Aborted Report (GLB.TASK=1)");
			audit.close();    	    	

			// Copia .ACT para .ERR
			if (GLB.AUDITACT.indexOf(".") != -1)
			{
				errLog = (GLB.AUDITACT.substring(0, GLB.AUDITACT.indexOf("."))).trim() + ".ERR";	    	
			}    	    	
...
//	AuditEOJ
	...
	{	    
		...
		if (GLB.AUDITACT.indexOf(".") != -1)
		{
			auditLog = (GLB.AUDITACT.substring(0, GLB.AUDITACT.indexOf("."))).trim() + ".LOG";	    	
		}    	    	
	...
	throws Exception
	{
		...
		{	
			...
			else   // Windows Printing
			{
				...
				GLB.SYSTEMDIR + File.separatorChar + "WEB-INF" + File.separatorChar + "classes";
