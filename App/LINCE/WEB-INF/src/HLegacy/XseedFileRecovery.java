...
public class XseedFileRecovery implements Serializable
{

	
	public transient  FileOutputStream outFile;
	public transient  FileInputStream inpFile;
	public transient  PrintStream out;
	public transient  BufferedReader inp;
