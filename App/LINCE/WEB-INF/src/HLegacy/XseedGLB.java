...
public class XseedGLB
{
	...
	public int   	ARRAYIDX1 = 0;
	public int   	ARRAYIDX2 = 0;
	public int    	ARRAYIDX3 = 0;
	...
	public String	   CALL = "     ";
    public CallableStatement    CALLABLECMD;
	...
	public double DC_LASTDAYMONTH = 0;
	public double DC_CC = 0;
	public double DC_CCYYDDD = 0;
	public double DC_CCYYMM = 0;
	public double DC_CCYYMMDD = 0;
	public double DC_CCYYMMLD = 0;
	...
	public double DC_MMCCYY = 0;
	public String DC_MM_CCYY = "          ";
	...
	public double PITCHC = 0;
	public double PITCHD = 0; 
	public double PITCHE = 0;
	public double PITCHF = 0; 
	public double PITCHG = 0;
	public double PITCHH = 0; 
	public double PITCHI = 0;
	public double PITCHJ = 0; 
	public double PITCHK = 0;
	public double PITCHL = 0; 
    public double PITCHM = 0;
	public double PITCHN = 0; 
	public double PITCHO = 0;
	public double PITCHP = 0; 
	public double PITCHQ = 0;
	public double PITCHR = 0; 
	public double PITCHS = 0; 
	public double PITCHT = 0;
	public double PITCHU = 0; 
	public double PITCHV = 0;
	public double PITCHW = 0; 
	public double PITCHX = 0; 
	public double PITCHY = 0;
	public double PITCHZ = 0; 			
	public String PRINTAT = "          ";
	public String PRINTATA = "          ";
	public String PRINTATB = "          ";
	public String PRINTATC = "          ";
	public String PRINTATD = "          ";
	public String PRINTATE = "          ";
	public String PRINTATF = "          ";
	public String PRINTATG = "          ";
	public String PRINTATH = "          ";
	public String PRINTATI = "          ";
	public String PRINTATJ = "          ";
	public String PRINTATK = "          ";
	public String PRINTATL = "          ";
	public String PRINTATM = "          ";
	public String PRINTATN = "          ";
	public String PRINTATO = "          ";
	public String PRINTATP = "          ";
	public String PRINTATQ = "          ";
	public String PRINTATR = "          ";
	public String PRINTATS = "          ";
	public String PRINTATT = "          ";
	public String PRINTATU = "          ";
	public String PRINTATV = "          ";
	public String PRINTATW = "          ";
	public String PRINTATX = "          ";
	public String PRINTATY = "          ";
	public String PRINTATZ = "          ";		

	public String PRINTBANNER = " ";
	public String PRINTBANNERA = " ";
	public String PRINTBANNERB = " ";
	public String PRINTBANNERC = " ";
	public String PRINTBANNERD = " ";
	public String PRINTBANNERE = " ";
	public String PRINTBANNERF = " ";
	public String PRINTBANNERG = " ";
	public String PRINTBANNERH = " ";
	public String PRINTBANNERI = " ";
	public String PRINTBANNERJ = " ";
	public String PRINTBANNERK = " ";
	public String PRINTBANNERL = " ";
	public String PRINTBANNERM = " ";
	public String PRINTBANNERN = " ";
	public String PRINTBANNERO = " ";
	public String PRINTBANNERP = " ";
    public String PRINTBANNERQ = " ";
	public String PRINTBANNERR = " ";
	public String PRINTBANNERS = " ";
	public String PRINTBANNERT = " ";
    public String PRINTBANNERU = " ";
	public String PRINTBANNERV = " ";
	public String PRINTBANNERW = " ";
	public String PRINTBANNERX = " ";
    public String PRINTBANNERY = " ";
	public String PRINTBANNERZ = " ";
	...
	public double      REPGENDATE = 0;
	public double      REPGENTIME = 0;
	...
	public String  STNHOST = "";
	public String  STYLE = "";
	public String  SYSTEMDIR = "";
	public double  SYSVERSION = 0.0;
	...
	public FileOutputStream file_LP;
	public PrintStream          LP;
    ...
    public XseedFile EXA;
    public XseedFile EXB;
    public XseedFile EXC;
    public XseedFile EXD;
    public XseedFile EXE;
    public XseedFile EXF;
    public XseedFile EXG;
    public XseedFile EXH;
    public XseedFile EXI;
    public XseedFile EXJ;
    public XseedFile EXK;
    public XseedFile EXL;
    public XseedFile EXM;
    public XseedFile EXN;
    public XseedFile EXO;
    public XseedFile EXP;
    public XseedFile EXQ;
    public XseedFile EXR;
    public XseedFile EXS;
    public XseedFile EXT;
    public XseedFile EXU;
    public XseedFile EXV;
    public XseedFile EXW;
    public XseedFile EXX;
    public XseedFile EXY;
    public XseedFile EXZ;
	...
	public PrintStream      LPA;
	public PrintStream      LPB;
	public PrintStream      LPC;
	public PrintStream      LPD;
	public PrintStream      LPE;
	public PrintStream      LPF;
	public PrintStream      LPG;
	public PrintStream      LPH;
	public PrintStream      LPI;
	public PrintStream      LPJ;
	public PrintStream      LPK;
	public PrintStream      LPL;
	public PrintStream      LPM;
	public PrintStream      LPN;
	public PrintStream      LPO;
	public PrintStream      LPP;
	public PrintStream      LPQ;
	public PrintStream      LPR;
	public PrintStream      LPS;
	public PrintStream      LPT;
	public PrintStream      LPU;
	public PrintStream      LPV;
	public PrintStream      LPW;
	public PrintStream      LPX;
	public PrintStream      LPY;
	public PrintStream      LPZ;
