  ...
  throws Exception
{
   try
   {
      ...
      out.println("#idPAGEUSER" + printStyle(PAGEUSER,cssPAGE1));
      out.println("#idPAGEPARAM" + printStyle(PAGEPARAM,cssPAGE1));
      out.println("#idPAGESEND" + printStyle(PAGESEND,cssPAGE1));
      out.println("</style>");
      ...
      out.println("  if (pEvent.keyCode == 35) frmPAGE1.PAGESEND.focus();");
      out.println("  if (pEvent.keyCode == 36) frmPAGE1.PAGEUSER.focus();");
      out.println("}");
      ...
      out.println("  frmPAGE1.PAGEUSER.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_PAGEUSER)) + "\";");
      if (SCREEN_PAGEPARAM.length() > 15)
         SCREEN_PAGEPARAM = SCREEN_PAGEPARAM.substring(0,15);
      out.println("  frmPAGE1.PAGEPARAM.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_PAGEPARAM)) + "\";");
      if (SCREEN_PAGESEND.length() > 5)
         SCREEN_PAGESEND = SCREEN_PAGESEND.substring(0,5);
      out.println("  frmPAGE1.PAGESEND.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_PAGESEND)) + "\";");
      out.println("}");
      ...
      LABEL3.print();
      out.println("  " + printTextbox(PAGEUSER,cssPAGE1) + " ");
      LABEL1.print();
      LABEL2.print();
      out.println("  " + printTextbox(PAGEPARAM,cssPAGE1) + " ");
      out.println("  " + printTextbox(PAGESEND,cssPAGE1) + " ");
      out.println("</SPAN>");
