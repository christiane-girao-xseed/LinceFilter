// Generated by Xseed Version 9.5.69 ( Date: 29/03/2022 10:13:2222 hs  User: DEFAULT )
import java.io.*;
...
@WebServlet(value="/servlet/PGTST")
public class PGTST extends XseedIspec
{
  ...
  throws Exception
{
   try
   {
      ...
      out.println("function button_mousemove(ptabId)");
      out.println("{");
      out.println("alert(\"BUTTON mousemove\");");
...
TXT = "button_mousemove('" + tabid + "')";
    ...
    BTN1.eventmethod[(int)BTN1.eventindex-1] = TXT;
   }
   catch(Exception e)
   {
