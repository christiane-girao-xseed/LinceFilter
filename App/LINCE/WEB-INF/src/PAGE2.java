  ...
  throws Exception
{
   try
   {
      ...
      out.println("#idTXT1" + printStyle(TXT1,cssPAGE2));
      out.println("#idTXT2" + printStyle(TXT2,cssPAGE2));
      out.println("</style>");
      ...
      out.println("  if (pEvent.keyCode == 35) frmPAGE2.TXT2.focus();");
      out.println("  if (pEvent.keyCode == 36) frmPAGE2.TXT1.focus();");
      out.println("}");
      ...
      out.println("  frmPAGE2.TXT1.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_TXT1)) + "\";");
      if (SCREEN_TXT2.length() > 100)
         SCREEN_TXT2 = SCREEN_TXT2.substring(0,100);
      out.println("  frmPAGE2.TXT2.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_TXT2)) + "\";");
      out.println("}");
      ...
      LABEL3.print();
      out.println("  " + printTextbox(TXT1,cssPAGE2) + " ");
      LABEL1.print();
      out.println("  " + printTextbox(TXT2,cssPAGE2) + " ");
      LABEL2.print();
      out.println("</SPAN>");
