  ...
  throws Exception
{
   try
   {
      ...
      out.println("#idPAGEUSER" + printStyle(PAGEUSER,cssLOGON));
      out.println("#idPAGESEND" + printStyle(PAGESEND,cssLOGON));
      out.println("</style>");
      ...
      out.println("  if (pEvent.keyCode == 35) frmLOGON.PAGESEND.focus();");
      out.println("  if (pEvent.keyCode == 36) frmLOGON.PAGEUSER.focus();");
      out.println("}");
      ...
      out.println("  frmLOGON.PAGEUSER.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_PAGEUSER)) + "\";");
      if (SCREEN_PAGESEND.length() > 5)
         SCREEN_PAGESEND = SCREEN_PAGESEND.substring(0,5);
      out.println("  frmLOGON.PAGESEND.value = \"" + rTrim(replaceSpecialCharacter(SCREEN_PAGESEND)) + "\";");
      out.println("}");
      ...
      out.println("  " + printTextbox(PAGEUSER,cssLOGON) + " ");
      out.println("  " + printTextbox(PAGESEND,cssLOGON) + " ");
      out.println("</SPAN>");
...
{  try
   {
    ...
    if( ((rTrim(SCREEN_PAGESEND)).equals(rTrim("PAGE1"))==true))
    {
        recall("PAGE1","");
    }
